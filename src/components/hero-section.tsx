                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        href="#link"
                                        className="hidden hover:bg-background dark:hover:border-t-border bg-muted group mx-auto w-fit items-center gap-4 rounded-full border p-1 pl-4 shadow-md shadow-zinc-950/5 transition-colors duration-300 dark:border-t-white/5 dark:shadow-zinc-950">
                                ...
                                <TextEffect
                                    ...
                                    A better way to chat simple, private, and just a bit curios.
                                </TextEffect>
                                <TextEffect
                                    per="line"
                                    preset="fade-in-blur"
                                    ...
                                    className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                                        NikoChat is a clean, fast messaging app with a unique style and a quiet feline touch.
                                </TextEffect>
