...
import { Button, Input, Avatar, Skeleton, ScrollShadow, Tooltip, Image } from '@heroui/react';
import {
  ArrowDownIcon, PaperAirplaneIcon, CheckIcon, ClockIcon,
  ExclamationCircleIcon, ArrowPathIcon, PhotoIcon
...
export const ChatWindow: React.FC<ChatWindowProps> = ({ conversation }) => {
  ...
  return (
    <div className="w-full flex flex-col h-full relative">
      <div className="p-3 flex items-center space-x-3 sticky top-0 z-10 cursor-pointer bg-base-100/80 backdrop-blur-md border-b border-base-200" onClick={handleHeaderClick}>
      ...
      <div className="p-3 bg-base-100 sticky bottom-0">
        <form onSubmit={handleSend} className="flex items-center space-x-2">
          ...
          />
          <Button type="submit" isIconOnly color="primary" radius='full' isDisabled={!newMessage.trim()}>
