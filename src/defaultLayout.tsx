  ...
  return (
    <>
      <div className="flex flex-row w-full max-h-auto md:min-h-screen md:max-h-screen bg-base-200 overflow-hidden">
        {!isMobileView && <Navbar />}
        <div className="flex w-full justify-center bg-base-100 md:border-base-300 md:border rounded-none md:rounded-2xl overflow-hidden md:overflow-scroll my-0 mr-0 md:my-2 md:mr-2 pb-16 md:pb-0 scrollbar-hide shadow-xl">
